...
def list_deployments(
    ...
    return DeploymentService(db).list_deployments()
...
def undeploy_model(
    ...
    return DeploymentService(db).undeploy_model(deployment_id)
...
def predict(
    ...
    return DeploymentService(db).predict(deployment_id, payload.features)
